...
<div class="row">
  <div class="col-lg-12 col-md-12">
    <form method="post" action="/mod/tpp">
      @csrf
      ...
      <div class="form-group">
        <div class="row">
          <div class="col-12">
            <button type="submit" class="btn btn-success btn-block" name="button">TAMBAHKAN</button>
          </div>
        </div>
      </div>
    </form>
      ...
      <table class="table table-bordered">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td><a href="/mod/tpp/delete/{{$item->id}}" onclick="return confirm('Yakin ingin dihapus?');"><span
                  class="badge bg-danger"><i class="fa fa-trash"></i></span></a></td>
          </tr>
          @endforeach
