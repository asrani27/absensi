      ...
      <div class="card-body">
        <div class="form-group row">
          <div class="col-12 text-center">
            Mohon maaf fitur foto sedang dalam perbaikan,Silahkan lakukan presensi tanpa foto
          </div>
        ...
        <form id="radius" method="post" action="/pegawai/presensi/radius">
          ...
          {{-- <div class="form-group row">
            <div class="col-6">
              <button type="submit" class="btn btn-block bg-gradient-success btnMasuk" name="button"
                value="masuk">MASUK</button>
            </div>
            <div class="col-6">
              <button type="submit" class="btn btn-block bg-gradient-danger btnPulang" name="button"
                value="pulang">PULANG</button>
            </div>
          </div> --}}
          <div class="form-group row">
