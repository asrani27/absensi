            ...
            <div class="card-footer bg-white p-0">
                <ul class="nav nav-pills flex-column">
                    ...
                    <li class="nav-item">
                        <a href="#" class="nav-link">
                            Presensi
                            <span class="float-right text-primary">Pagi</span>
                        </a>
                    </li>
                    ...
                    <li class="nav-item">
                        <a href="/pegawai/presensi/pagi" class='btn btn-xs btn-primary btn-block'><i
...
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            <div class="card-body">
                <form id="radius" method="post" action="/pegawai/presensi/pagi">
                    @csrf
