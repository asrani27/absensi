...
<div class="row">
    <div class="col-12">
        <a href="/admin/lokasi/create" class="btn btn-sm btn-primary"><i class="fa fa-map-marker"></i> Tambah Lokasi</a><br/><br/>
        <div class="card">
        ...
        <div class="card-body table-responsive p-0">
            ...
            @foreach ($data as $key => $item)
                    ...
                    <form action="/admin/lokasi/{{$item->id}}" method="post">
                        <a href="/admin/lokasi/{{$item->id}}/edit" class="btn btn-xs btn-success"><i class="fas fa-edit"></i> Edit</a>
                        @csrf
                        @method('delete')
