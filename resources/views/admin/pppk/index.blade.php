...
<div class="row">
    <div class="col-12">
        ...
        <form method="get" action="/admin/pppk/puskesmas">
            @csrf
            <div class="row">
                <div class="col-sm-6">
        ...
        <div class="card">
            <div class="card-header">
                ...
                <div class="card-tools">
                    <form method="get" action="/admin/pppk/search">
                    ...
                    <tbody>
                        ...
                        <tr style="font-size:11px; font-family:Arial, Helvetica, sans-serif; ">
                            ...
                            <td>
                                ...
                                @else
                                {{$item->lokasi->nama}}
                                <a href="/admin/pppk/{{$item->id}}/editlokasi" class="btn btn-xs bg-gradient-success"><i
                                        class="fas fa-pen"></i></a>
                                @endif
                                @endif
                            </td>
                            ...
                            <td>
                                ...
                                <a href="/admin/pppk/{{$item->id}}/resetpass"
