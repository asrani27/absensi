...
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header">
                Laporan presensi Bulan {{convertBulan($bulan)}}
                {{$tahun}}
            </div>
            <div class="card-body">
                <a href="/admin/laporan/rekap/{{$bulan}}/{{$tahun}}/sekolah/pdf" target="_blank"
                    class="btn btn-xs btn-danger">Export PDF</a>
                <a href="/admin/laporan/rekap/{{$bulan}}/{{$tahun}}/sekolah/masukkanpegawai"
                    class="btn btn-xs btn-primary"
                    onclick="return confirm('Yakin Ingin Memasukkan Semua Pegawai Pada Bulan Ini?');">Masukkan
                    Semua Pegawai</a>

                <a href="/admin/laporan/rekap/{{$bulan}}/{{$tahun}}/sekolah/hitungsemua" class="btn btn-xs btn-primary"
                    onclick="return confirm('Proses ini memakan beberapa waktu, harap di tunggu?');">Hitung Semua</a>

                <a href="/admin/laporan/rekap/{{$bulan}}/{{$tahun}}/sekolah/hitungtotalharikerja"
                    class="btn btn-xs btn-primary"
                    onclick="return confirm('Proses ini memakan beberapa waktu, harap di tunggu?');">Hitung Total Hari
                    Kerja</a>

                <a href="/admin/laporan/rekap/{{$bulan}}/{{$tahun}}/sekolah/hitungpersentase"
                    class="btn btn-xs btn-primary"
                    onclick="return confirm('Proses ini memakan beberapa waktu, harap di tunggu?');">Hitung
                    Persentase</a>

                {{-- <a href="/admin/laporan/rekap/{{$bulan}}/{{$tahun}}/sekolah/100" class="btn btn-xs btn-primary"
                    onclick="return confirm('Proses ini memakan beberapa waktu, harap di tunggu?');">100 %</a> --}}
                <br /><br />
