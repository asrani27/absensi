...
<body>
    <header>
        <p style="text-align: center"><span class="auto-style1"><strong>LAPORAN PRESENSI 17 FEBRUARI 2025
        ...
        <table width="100%" cellpadding="6" cellspacing="0">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td style="text-align: center">{{\Carbon\Carbon::parse($item->jam_masuk)->format('H:i:s')}}</td>
