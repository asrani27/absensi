...
<div class="row">
    <div class="col-12">
        <a href="/puskesmas/cuti" class="btn btn-sm btn-secondary"><i class="fas fa-arrow-left"></i>
            Kembali</a><br /><br />

        <form method="post" action="/puskesmas/cuti/create" enctype="multipart/form-data">
            @csrf
            <div class="row">
