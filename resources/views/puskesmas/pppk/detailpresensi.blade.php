...
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            ...
            <div class="card-body">
                <a href="/puskesmas/pppk/{{$id}}/presensi" class="btn btn-xs btn-secondary"><i
                        class="fas fa-arrow-left"></i> Kembali</a>
                <a href="/puskesmas/pppk/{{$id}}/presensi/generate/{{$bulan}}/{{$tahun}}" class="btn btn-xs btn-info">
                    Generate Absensi</a>
                <br /><br />
                <table class="table table-hover table-striped text-nowrap table-sm">
                    ...
                    <tbody>
                        ...
                        <tr style="font-size:11px; font-family:Arial, Helvetica, sans-serif">
                            ...
                            <td><a href="/puskesmas/pppk/{{$id}}/presensi/{{$bulan}}/{{$tahun}}/{{$item->id}}/edit"><i
