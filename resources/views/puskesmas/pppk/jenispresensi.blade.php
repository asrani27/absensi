...
<div class="row">
    <div class="col-12">
        <a href="/puskesmas/pppk" class="btn btn-sm btn-secondary"><i class="fas fa-arrow-left"></i>
            Kembali</a><br /><br />
        <form method="post" action="/puskesmas/pppk/{{$data->id}}/jenispresensi">
            @csrf
            <div class="row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <select class="form-control" name="jenis_presensi" required>
                                        ...
                                        <option value='4' {{$data->jenis_presensi == 4 ? 'selected':''}}>5 Hari Kerja
                                            (Sekolah)
                                        </option>
                                        <option value='5' {{$data->jenis_presensi == 5 ? 'selected':''}}>6 Hari Kerja
                                            (Sekolah)
                                        </option>
                                    </select>
                                </div>
